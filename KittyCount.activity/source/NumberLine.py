...
class NumberLine:
    ...
    def __init__(self, screen, w, h):
        ...
        self.spacing = int((w-60) / self.num_of_points)  # in pixels
        self.start_x = int(self.spacing / 2)+30  # x where the first point is and the number line starts
        self.end_x = int(w - self.spacing / 2)-30  # x where the last point is and the number line ends
