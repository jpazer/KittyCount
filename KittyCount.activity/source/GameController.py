...
class GameController:
    ...
    def __init__(self, _screen):
        ...
        # make cat
        self.cat = Character(self.number_line.circle_pos, self.LEFT_CAT, int(self.number_line.spacing * 1.3), int(self.number_line.spacing *1.3), self.screen)
        self.cat_position = -1

        # make mouse
        self.mouse = Character(self.number_line.circle_pos, self.MOUSE, int((self.number_line.spacing/2)*1.3), int((self.number_line.spacing/2)*1.3), self.screen, self.cat.get_x_pos())
